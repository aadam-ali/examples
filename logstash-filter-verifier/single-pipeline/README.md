# LFV for a Single Pipeline

## Overview

This example shows how to use Logstash Filter Verifier for a single
pipeline.

It makes use of the latest 'stable' release of LFV
([v1.6.3](https://github.com/magnusbaeck/logstash-filter-verifier/releases/tag/1.6.3))
